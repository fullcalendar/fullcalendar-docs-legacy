...
Making a full-featured view is beyond the scope of this document. Further documentation should be written and further APIs should be formalized, but for now, it would be best to browse FullCalendar's [source on GitHub]({{ site.repo_url }}). Pay attention to how [BasicView](https://github.com/fullcalendar/fullcalendar/blob/v3/src/basic/BasicView.ts) and [AgendaView](https://github.com/fullcalendar/fullcalendar/blob/v3/src/agenda/AgendaView.ts) are implemented.
