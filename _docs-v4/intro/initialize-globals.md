...
The first step is to download and unzip a ZIP archive from the [Getting Started page](/getting-started). Alternatively, you can use a CDN like [UNPKG](https://unpkg.com/). Once you get ahold of the files, do something like this:
